    ...
    public partial class GazeManager : Singleton<GazeManager>
    {
        ...
        private void UpdateRaycast()
        {
            ...
            if (Hit)
            {
                ...
                if (HitInfo.collider.GetComponent<SnapToPosition>())
                {
                    if (!HitInfo.collider.GetComponent<SnapToPosition>().isInteracting)
                    {
                        //check you're not hitting the object you're dragging.
